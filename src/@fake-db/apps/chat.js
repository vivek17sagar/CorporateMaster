  ...
  contacts: [
    {
      ...
      about: 'Frontend Developer working in Ahmedabad',
    ...
    {
      id: 5,
      fullName: 'Ravi Kumar Das',
      role: 'Dietitian',
      about: 'Studying in IIT',
      avatar: require('@src/assets/images/portrait/small/avatar-s-5.jpg').default,
      status: 'busy'
    },
    {
      id: 6,
      fullName: 'Balasundari Vaidyanathan',
      role: 'UI/UX SME',
      about:
        'Currently teaching in Infosys.',
