      ...
      <Card className='plan-card border-primary'>
        <CardHeader className='pt-75 pb-0'>
          <div className='w-100 d-flex justify-content-between'>
            <div>
              ...
              <CardSubtitle tag='h5' className='text-muted'>{user.policyCode}</CardSubtitle>
            </div>
            <div>
        ...
        <CardBody>
          <ul className='list-unstyled my-1'>
            ...
            <li className='my-25'>
              <span className='align-middle'>{user.policyStartDate} - {user.policyEndDate}</span>
            </li>
            <li>
              <span className='align-middle'>Family Members - {user.policyMember || 'NA'}</span>
            </li>
          </ul>
