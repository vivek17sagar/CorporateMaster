...
const ClaimAnalysis2 = () => {
  ...
  const [data, setData] = useState([
    ...
    {
      status: "Cashless Received pending for statement",
      noOfClaims: "14",
      cost: "333333",
    },
  ...
  const incidenceRatioProjectionColumns = [
    { name: "RELATION", sortable: true, selector: "relation" },
    {
      ...
      sortable: true,
      selector: "currentMembers1",
      center: true,
    },
    {
      name: "CURRENT MEMBERS",
      sortable: true,
      selector: "currentMembers2",
      center: true,
    },
    {
      name: "EOP CLAIMS",
    ...
    {
      name: "CURRENT INCIDENCE",
      sortable: true,
      selector: "currentIncidence",
      minWidth: "50px",
      center: true,
    },
    {
    ...
    <Fragment>
      <Row>
        <Col xs="12">
          <Card>
            <CardHeader>
              <CardTitle tag="h3">Claim Incidence Ratio & Projection</CardTitle>
            </CardHeader>
            <Row>
              <Col lg="6" xs="12">
                <DataTable
        ...
        <Col xs="12">
          <Card>
            ...
            <CardBody>
              <ul>
                <li>
                  Parent are the highest claiming group in terms of both no. of
                  claims and claim cost.
                </li>
                <li>
                  Average claim cost for Heinz India Pvt Ltd as a whole is above
                  industry.
                </li>
                <li>
                  Only settled claims are considered for average claim cost.
                </li>
              </ul>
            </CardBody>
          </Card>
